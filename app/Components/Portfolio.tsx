      ...
      <div className="portfolio-container">
        <div className="portfolio-box">
          ...
          <div className="portfolio-layer">
            ...
            <a href="http://governor-sindh-web-clone-two.vercel.app" target="_blank" rel="noopener noreferrer" aria-label="Visit Sindh Governor's website"><i className="bx bx-link-external"></i></a>
          </div>
        </div>
        ...
        <div className="portfolio-box">
          ...
          <div className="portfolio-layer">
            ...
            <a href="http://glam-bags-website-j2sw.vercel.app" target="_blank"  rel="noopener noreferrer" aria-label="Visit Glam Bag Website"><i className="bx bx-link-external"></i></a>
          </div>
        </div>
        ...
        <div className="portfolio-box">
          ...
          <div className="portfolio-layer">
            ...
            <a href="http://hackathon-nu-eight.vercel.app" target="_blank" rel="noopener noreferrer" aria-label="Visit Resume Builder"><i className="bx bx-link-external"></i></a>
          </div>
        </div>
        ...
        <div className="portfolio-box">
          ...
          <div className="portfolio-layer">
            ...
            <a href="http://to-do-list-web-page.vercel.app" target="_blank" rel="noopener noreferrer" aria-label="Visit Todo List"><i className="bx bx-link-external"></i></a>
          </div>
        </div>
        ...
        <div className="portfolio-box">
          ...
          <div className="portfolio-layer">
            ...
            <a href="http://tic-tac-toe-web-project.vercel.app" target="_blank" rel="noopener noreferrer" aria-label="Visit Tic Tac Toe"><i className="bx bx-link-external"></i></a>
          </div>
        </div>
        ...
        <div className="portfolio-box">
          ...
          <div className="portfolio-layer">
            ...
            <a href="http://calculator-web-page.vercel.app" target="_blank" rel="noopener noreferrer" aria-label="Visit Calculator"><i className="bx bx-link-external"></i></a>
          </div>
        </div>
      </div>
    </section>
